...
public class Menu {
   ...
   // Informar o nome
	...
	// Mostra comparações Encadeadas
	public void mostraLista(int count)
	{
		out.println("Foram feitas " + count + " comparações Encadeadas.");
	}
	
	// Mostra comparações binpárias
	public void mostraBinarios(int count)
	{
		out.println("Foram feitas " + count + " comparações Binárias.");
	}
}